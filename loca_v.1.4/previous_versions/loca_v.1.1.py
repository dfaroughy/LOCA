...
class lhco_open(object):
    ...
    def __enter__(self):
            ...
            if len(line)>3:
                ...
                if _object_.is_last_in_event:
                    ...
                    if self.plots:
                        ...
                        # spectrum_photon_1.get_spectra(leading(event._photons_,0))
                        # spectrum_photon_2.get_spectra(leading(event._photons_,1))
                        # spectrum_electron_1.get_spectra(leading(event._electrons_,0))
                        # spectrum_electron_2.get_spectra(leading(event._electrons_,1))
                        # spectrum_muon_1.get_spectra(leading(event._muons_,0))
                        # spectrum_muon_2.get_spectra(leading(event._muons_,1))
        ...
        if self.plots:
            ...
            # spectrum_photon_1.plot_spectra(r'$\gamma$ leading'        ,fig,9,15)
            # spectrum_photon_2.plot_spectra(r'$\gamma$ subleading'     ,fig,10,15)
            # spectrum_electron_1.plot_spectra(r'$e^{\pm}$ leading'     ,fig,1,15)
            # spectrum_electron_2.plot_spectra(r'$e^{\pm}$ sub-leading' ,fig,2,15)
            # spectrum_muon_1.plot_spectra(r'$\mu^{\pm}$ leading'       ,fig,3,15)
            # spectrum_muon_2.plot_spectra(r'$\mu^{\pm}$ sub-leading'   ,fig,4,15)
